...
<html lang="en" dir="ltr">
  ...
  <body style="background-color:rgba(51,48,48);">
    ...
    require "navbar.php";
     ...
     <div id="form-input">
     <form action='AddNewMealCheck.php' method='post' onsubmit='return Error(this)' id='addstall-form' enctype="multipart/form-data">

     <input type='text' id='meal-name' name='meal-name' placeholder="Meal's Name...">

     <input type='text' id='meal-price' name='meal-price' placeholder="Meal's Price..." onkeyup="checkDec(this)" autocomplete="off">

     <textarea id='meal-desc' name='meal-desc' placeholder="Meal's Description"></textarea>
     ...
     <input type="text" name="meal-discount" placeholder="Discount apply (in MYR)..." id="meal-discount" onkeyup="checkDec(this)">
