...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <a href="TopupHistory.php" id="link"><div id="user-info-2-link-th" style="background-color:#03a9f4;">TOP-UP HISTORY</div></a>
      ...
      <div style="padding-left:10px;">TOP-UP HISTORY</div>
      ...
      while ($rows = mysqli_fetch_array($result)) {
        ...
        <div id='table-data' style='padding-left:15px;'>LOREM IPSUM</div>

        <div id='table-data'>".$rows['Topup_Date']."</div>

        <div id='table-data'>".number_format($rows['Topup_Amount'],2)."</div>
      ...
      $sql = "SELECT SUM(Topup_Amount) as TotalAmount FROM topup WHERE User_ID ='".$_SESSION['Username']."'";
      ...
      if (mysqli_num_rows($result) > 0) {
        echo "YOU HAVE TOP-UP A TOTAL OF <p style='color:white;display:inline-block;'>MYR ".number_format($rows['TotalAmount'],2)."</p> in APU's cafeteria";
      }
      else {
        echo "YOU HAVE TOP-UP A TOTAL OF <p style='color:white;display:inline-block;'>MYR 0.00</p> in APU's cafeteria";
      }
      ...
      $sql = "SELECT MONTH(Topup_Date) as Month, YEAR(Topup_Date) as Year FROM topup WHERE User_ID ='".$_SESSION['Username']."' GROUP BY Month,Year ORDER BY Year DESC,Month DESC";
      ...
      $topuppermonth = "SELECT SUM(Topup_Amount) as TopupPerMonth from topup WHERE User_ID='".$_SESSION['Username']."' && MONTH(Topup_Date) = '".$Thismonth."' && YEAR(Topup_Date) = '".$Thisyear."'

                        ORDER BY Topup_Date";

      $topuppermonthresult = mysqli_query($conn, $topuppermonth);

      $topuppermontharray = mysqli_fetch_array($topuppermonthresult);
      ...
      echo "<div id='history-title'>
            ...
            <p style='display:inline-block;padding:0;margin:0;margin-top:5px;'>You have spent</p> MYR ".number_format($topuppermontharray['TopupPerMonth'],2)." <br> in ".$monthname2." ".$Thisyear."
      ...
      $sql3 = "SELECT MONTH(Topup_Date) as Month2, YEAR(Topup_Date) as Year2 FROM topup
      ...
      if ($rows3['Month2'] == $Thismonth && $rows3['Year2'] == $Thisyear) {
          ...
          echo "
                ...
                <div id='history-bars'>
                 ...
                 <img src='SDP materials/plus.png'> <p style='display:inline-block;float:right;margin-right:10px;'>MYR ".number_format($rows2['Topup_Amount'],2)."</p>
